...
const TodolistPage = (props) => {
    ...
    useEffect(() => {
        ...
        fetch("https://todobackend10.herokuapp.com/user/todolist", {
            // Adding method type
            method: "GET",
    ...
    const StartTimerOfTodo = (index, status, objStartDate) => {
        fetch("https://todobackend10.herokuapp.com/user/todo-start", {
            // Adding method type
            method: "PUT",
            // Adding headers to the request
            headers: {
    ...
    const PauseTimerOfTodo = (index, status, diffTime) => {
        fetch("https://todobackend10.herokuapp.com/user/todo-pause", {
            // Adding method type
            method: "PUT",
            // Adding headers to the request
            headers: {
    ...
    const EndTimerOfTodo = (index, status, diffTime) => {
        fetch("https://todobackend10.herokuapp.com/user/todo-end", {
            // Adding method type
            method: "PUT",
            // Adding headers to the request
            headers: {
